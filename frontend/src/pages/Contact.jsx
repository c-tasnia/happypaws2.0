...
const Contact = () => {
  // ✅ ALL useState hooks together inside the component
    ...
    <div className="bg-[#f8f7f4] text-[#2c2b28] font-sans">
      ...
      <div className="grid md:grid-cols-3 gap-5 max-w-5xl mx-auto px-6">
        <div className="bg-[#e8f5f0] border border-[#c5e8dc] rounded-2xl p-8 text-center hover:shadow-lg transition">
          <div className="w-12 h-12 bg-[#c5e8dc] rounded-full flex items-center justify-center mx-auto mb-4 text-xl">📞</div>
          <h3 className="font-serif font-semibold mb-2">Phone</h3>
          <p className="text-sm text-gray-600 mb-3">We're available during office hours for any inquiries.</p>
          <a href="tel:+8801700000000" className="text-[#2c6e5a] font-medium">+880 1700-000000</a>
        </div>

        <div className="bg-[#fef3ec] border border-[#f8d9c1] rounded-2xl p-8 text-center hover:shadow-lg transition">
          <div className="w-12 h-12 bg-[#f8d9c1] rounded-full flex items-center justify-center mx-auto mb-4 text-xl">✉️</div>
          <h3 className="font-serif font-semibold mb-2">Email</h3>
          <p className="text-sm text-gray-600 mb-3">Drop us a message and we'll reply within 24 hours.</p>
          <button onClick={() => setShowModal(true)} className="text-[#2c6e5a] font-medium">
            hello@happypaws.org
          </button>
        </div>

        <div className="bg-[#f2f0fb] border border-[#dcd8f5] rounded-2xl p-8 text-center hover:shadow-lg transition">
          <div className="w-12 h-12 bg-[#dcd8f5] rounded-full flex items-center justify-center mx-auto mb-4 text-xl">📍</div>
          <h3 className="font-serif font-semibold mb-2">Location</h3>
          <p className="text-sm text-gray-600">123 Shelter Lane <br /> Chattogram 1207, Bangladesh</p>
        </div>
      </div>
        ...
        <div className="bg-white rounded-2xl border overflow-hidden">
          ...
          <div className="flex justify-between items-center p-6">
            <div className="text-sm text-gray-700">
              <strong className="block text-black mb-1">Happy Paws Animal Shelter</strong>
      ...
      {showModal && (
        <div className="fixed inset-0 bg-black/40 flex items-center justify-center z-50">
          <div className="bg-white rounded-2xl p-6 w-[90%] max-w-md relative shadow-lg">
            ...
            <h2 className="text-xl font-serif font-semibold mb-4">Send us a message</h2>
            <form onSubmit={handleSubmit} className="flex flex-col gap-3">
              ...
              <textarea
                ...
                required
              />
              <button type="submit" className="bg-[#2c6e5a] text-white py-2 rounded-lg hover:bg-[#245c4b] transition">
                Send Message
              </button>
            </form>
          </div>
